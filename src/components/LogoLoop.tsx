...
type ImageLogoItem = BaseLogoItem & {
  src: string;
  alt?: string;
  srcSet?: string;
  sizes?: string;
...
type NodeLogoItem = BaseLogoItem & {
  node: React.ReactNode;
};

export type LogoLoopItem = ImageLogoItem | NodeLogoItem;
...
function useResizeObserver(callback: () => void, elements: React.RefObject<HTMLElement | null>[], deps: ReadonlyArray<unknown>) {
  useEffect(() => {
...
function useImageLoader(seqRef: React.RefObject<HTMLElement | null>, onLoad: () => void, deps: ReadonlyArray<unknown>) {
  useEffect(() => {
